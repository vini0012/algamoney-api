...
public class S3Config {
    ...
    public AmazonS3 amazonS3() {
        ...
        if (!amazonS3.doesBucketExistV2(property.getS3().getBucket())) {
            ...
            BucketLifecycleConfiguration.Rule regraExpedicao = new BucketLifecycleConfiguration.Rule()
            ...
            BucketLifecycleConfiguration configuration = new BucketLifecycleConfiguration().withRules(regraExpedicao);
