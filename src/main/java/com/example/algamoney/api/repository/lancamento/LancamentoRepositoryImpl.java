...
public class LancamentoRepositoryImpl implements LancamentoRepositoryQuery {
    ...
    @PersistenceContext //trabalhar com consulta SQL
    ...
    public Page<Lancamento> filtrar(LancamentoFilter lancamentoFilter, Pageable pageable) {
        ...
        //Total de resultados da paginação
    ...
    public Page<ResumoLancamento> resumir(LancamentoFilter lancamentoFilter) {
        ...
        adicionarRestricoesDePaginacao(query, lancamentoFilter.getPageable());

        return new PageImpl<>(query.getResultList(), lancamentoFilter.getPageable(), total(lancamentoFilter));
    }
    ...
    private Predicate[] criarRestricoes(LancamentoFilter lancamentoFilter, CriteriaBuilder builder,
        ...
        //where descricao like '%dasdsadsa%'
